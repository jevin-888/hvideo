// 引擎 app 端 Parcelable 实现
// 部署路径: app/src/main/java/android/wfd_sink/WfdSinkStatus.java
...
/**
 * WFD Sink 服务运行状态快照（app 端副本）。
 * 字段必须和 AOSP framework 里的 WfdSinkStatus 完全一致，否则反序列化失败。
 */
